...
|Buscar por data|Marcar para filtrar por data|-|
...
|Zona Horária de Início ||America/Bahia|
|Data de Fim ||2015-05-28T12:00:00|
|Zona Horária de Fim ||America/Bahia|
...
|Convidados |Para mais de um convidado armar uma lista|['lpage@example.com', 'sbrin@example.com']|
